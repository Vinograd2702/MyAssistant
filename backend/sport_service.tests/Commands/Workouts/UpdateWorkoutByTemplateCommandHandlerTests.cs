...
{
    public class UpdateWorkoutByTemplateCommandHandlerTests
        : TestCommandBase
    {
        [Fact]
        public async Task UpdateWorkoutByTemplateCommandHandler_Success()
        {
            // Arrange
            var handler = new UpdateWorkoutByTemplateCommandHandler(_context);
            ...
            var workoutEntityBeforeUpdate = _context.Workouts
                .Find(workoutId);
            ...
            await handler.Handle(
                new UpdateWorkoutByTemplateCommand
                {
                    Id = workoutId,
                    UserId = userId,
